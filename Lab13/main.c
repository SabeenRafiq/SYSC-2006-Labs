...
int main(void)
{
    ...
    printf("\nREPLACE: \n");
    replace(addresses, "Babak", "donald.bailey@carleton.ca");
    printf("\nExpect: Babak -> donald.bailey@carleton.ca\n\n");
    print_dictionary(addresses);
    replace(addresses, "Sabeen", "donald.bailey@carleton.ca");
    printf("\nExpect: Sabeen -> No change\n\n");
    print_dictionary(addresses);
